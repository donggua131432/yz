...
/**
 * 2016年8月17日中午12时以后 报读成教奖学金 并缴纳辅导费
 * 
 * @author C
 *
 */
public class CC_AF_2016_08_17_12H_CJBM_JXJ implements Calculator {
	...
	public MpResult output(MpCondition condition) {
		...
		map.put("excDesc", "推荐2016年8月17日中午12时以后录入的被推荐人，报读成教奖学金并缴纳辅导费后");
