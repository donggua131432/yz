...
/**
 * 2016年8月17日中午12时以后 报读成教奖学金 并缴纳第一年学费
 * 
 * @author C
 *
 */
public class CC_AF_2016_08_17_12H_CJZC_JXJ implements Calculator {
	...
	public MpResult output(MpCondition condition) {
		...
		map.put("excDesc", "推荐2016年8月17日中午12时以后录入的被推荐人，报读成教奖学金 并缴纳第一年学费");
