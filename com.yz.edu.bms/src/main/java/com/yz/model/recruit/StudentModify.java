...
public class StudentModify {
	...
	public String getNewUnvsName() {
		return newUnvsName;
	}

	public void setNewUnvsName(String newUnvsName) {
		this.newUnvsName = newUnvsName;
	}

	public String getNewTaName() {
		return newTaName;
	}

	public void setNewTaName(String newTaName) {
		this.newTaName = newTaName;
	}

	public String getNewPfsnName() {
		return newPfsnName;
	}

	public void setNewPfsnName(String newPfsnName) {
		this.newPfsnName = newPfsnName;
	}
	...
	public String getNewPfsnLevel()
	{
		return newPfsnLevel;
	}

	public void setNewPfsnLevel(String newPfsnLevel)
	{
		this.newPfsnLevel = newPfsnLevel;
	}
