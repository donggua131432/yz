 ...
 * @author jyt
 */
public class StudentCertificateQuery
{
	...
	private String fdyStartTime;
	private String fdyEndTime;
	...
	public String getFdyStartTime() {
		return fdyStartTime;
	}

	public void setFdyStartTime(String fdyStartTime) {
		this.fdyStartTime = fdyStartTime;
	}

	public String getFdyEndTime() {
		return fdyEndTime;
	}

	public void setFdyEndTime(String fdyEndTime) {
		this.fdyEndTime = fdyEndTime;
	}
